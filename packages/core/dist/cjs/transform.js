...
exports.tailpropsTailwindTransform = exports.withTailprops = void 0;
 ...
 */
function withTailprops(extensions, config) {
 ...
 */
function tailpropsTailwindTransform(content) {
...
exports.tailpropsTailwindTransform = tailpropsTailwindTransform;
/**
...
function transformRawTailwindProp(raw) {
    ...
    const modifiers = (0, utils_1.getTailwindModifiersInAttribute)(modifiersString);
    const rawPropertiesMatches = [...raw.matchAll(/"(.*?)"/g)];
    for (const match of rawPropertiesMatches.reverse()) {
        const properties = (0, utils_1.getTailwindPropertiesInString)(match[1]);
        const joinedProperties = (0, utils_1.joinPropertiesUsingModifiers)(properties, modifiers);
        raw =
