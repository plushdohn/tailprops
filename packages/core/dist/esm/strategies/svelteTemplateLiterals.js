...
export function transpileUsingTemplateLiteralAttributeInjection(source, options = {
...
function applyModifiersToAllInQuotes(source, modifiers) {
    ...
    return matches.reverse().reduce((acc, m) => {
        ...
        const modifiedProperties = joinPropertiesUsingModifiers(properties, modifiers);
